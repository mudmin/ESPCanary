 ...
 * By AnotherMaker - https://youtube.com/AnotherMaker
 * Forked and repurposed from https://github.com/nailbuster/esp8266FTPServer
...
void FtpServer::clientConnected()
{
  ...
  #endif
  client.println( "220--- Welcome to FTP ---");
